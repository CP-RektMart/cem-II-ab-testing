      ...
      <div id="courseville-body">
        <div id="courseville-content-wrap">
          ...
          <div id="courseville-panel-wrap">
            <div
              id="courseville-panel-tab-top"
              className="cvui-colorset-2"
            ></div>
            ...
            <div
              id="courseville-panel-tab-bottom"
              className="cvui-colorset-2"
            />
                          ...
                          >
                            ...
                            <div className="courseville-courseicon-text">
                              ...
                              <div data-info="courseno-title">
                                ...
                                <div data-part="title">
                                  Computer Engineering Mathematics II [Section
                                  1]
                                </div>
                              </div>
                            </div>
                          ...
                          >
                            ...
                            <div className="courseville-courseicon-text">
                              ...
                              <div data-info="courseno-title">
                                ...
                                <div data-part="title">
                                  Computer Engineering Mathematics Lab [Section
                                  1 - 2]
                                </div>
                              </div>
                            </div>
                          ...
                          >
                            ...
                            <div className="courseville-courseicon-text">
                              ...
                              <div data-info="courseno-title">
                                ...
                                <div data-part="title">
                                  Hardware Synthesis Laboratory I [Section 1 -
                                  2]
                                </div>
                              </div>
                            </div>
                          ...
                          >
                            ...
                            <div className="courseville-courseicon-text">
                              ...
                              <div data-info="courseno-title">
                                ...
                                <div data-part="title">
                                  Software Engineering I [Section 1 - 3 &amp;
                                  33]
                                </div>
                              </div>
                            </div>
        ...
        <footer id="courseville-footer-wrap">
          <div id="cvfooter-content">
            ...
            <div id="cvfooter-operator">
              LMS and Online Course Platform within mycourseville.com are
              operated by{" "}
